...
namespace Limoee.Web.UI.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new LimoeeUser { UserName = model.UserName, Email = model.Email };
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            var email = externalLoginInfo.ExternalIdentity.FindFirst(x => x.Type == ClaimTypes.Email).Value;
            ...
            else
            {
                ...
                return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { UserName = externalLoginInfo.DefaultUserName });
            }
        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new LimoeeUser { UserName = model.UserName,Email = info.Email,EmailConfirmed = true};
