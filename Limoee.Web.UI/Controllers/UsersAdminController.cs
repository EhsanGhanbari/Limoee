...
namespace Limoee.Web.UI.Controllers
{
    ...
    {
        private readonly LimoeeUserManager _userManager;
        private readonly LimoeeRoleManager _roleManager;
        ...
        public async Task<ActionResult> Create(RegisterViewModel userViewModel, params string[] selectedRoles)
        {
            ...
            {
                var user = new LimoeeUser { UserName = userViewModel.Email, Email = userViewModel.Email };
