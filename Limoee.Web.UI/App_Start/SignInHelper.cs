...
namespace Limoee.Web.UI
{
    ...
    {
        public SignInHelper(LimoeeUserManager userManager, IAuthenticationManager authManager)
        {
            UserManager = userManager;
            AuthenticationManager = authManager;
        }

        public static async Task<ClaimsIdentity> GenerateUserIdentityAsync(LimoeeUser user, UserManager<LimoeeUser> manager)
        {
        ...
        public LimoeeUserManager UserManager { get; private set; }

        public IAuthenticationManager AuthenticationManager { get; private set; }

        public async Task SignInAsync(LimoeeUser user, bool isPersistent, bool rememberBrowser)
        {
            // Clear any partial cookies from external or two factor partial sign ins
            AuthenticationManager.SignOut(DefaultAuthenticationTypes.ExternalCookie, DefaultAuthenticationTypes.TwoFactorCookie);
            var userIdentity = await GenerateUserIdentityAsync(user,UserManager);
            if (rememberBrowser)
            {
        ...
        private async Task<SignInStatus> SignInOrTwoFactor(LimoeeUser user, bool isPersistent)
        {
